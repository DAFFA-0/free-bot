...
const devlopernumber = "94727163302"
...
let ping = await conn.sendMessage(from , { text: '*_Pinging to Solo-leveling Module..._* ❗'  } )
...
const infomsg = `🖥️ *SOLO-LEVELING MD SYSTEM INFO* 🖥️
...
const config = require('../settings')
        const vcard = 'BEGIN:VCARD\n' +
            'VERSION:3.0\n' +
            'FN:' + 'ꜱᴏʟᴏ-ʟᴇᴠᴇʟɪɴɢ ʙʏ ʀᴜᴋᴀ ᴏꜰᴄ' + '\n' +
            'ORG:;\n' +
            'TEL;type=CELL;type=VOICE;waid=' + owner[0] + ':+' + owner[0] + '\n' +
            'END:VCARD'
        let buttonMessaged = {
            contacts: { displayName: 'ꜱᴏʟᴏ-ʟᴇᴠᴇʟɪɴɢ ʙʏ ʀᴜᴋᴀ ᴏꜰᴄ', contacts: [{ vcard }] },
            contextInfo: {
                externalAdReply: {
                    title: 'ꜱᴏʟᴏ-ʟᴇᴠᴇʟɪɴɢ ʙʏ ʀᴜᴋᴀ ᴏꜰᴄ',
                    body: 'Touch here.',
                    renderLargerThumbnail: true,
                    thumbnailUrl: ``,
                    thumbnail: `https://files.catbox.moe/vuifao.jpeg`,
                    mediaType: 2,
                    mediaUrl: '',
...
*╰──────────●●►*
*👸 ＳＯＬＯ-ＬＥＶＥＬＩＮＧ ＭＤ ᴄᴏᴍᴍᴀɴᴅꜱ ᴘᴀɴᴇʟ*
*╭──────────●●►*
*│🧙‍♂️ DOWNLOAD COMMANDS*
*│   ───────*
...
try{                   
  ...
  if (!isMe) return await reply(BOTOW)
                reply(`Solo-leveling md shutdown few 10 seconds...`)
                await sleep(10000)
                process.exit()
...
async(conn, mek, m,{from, prefix, l, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply}) => {
try{       
if (!q) return mek.reply(`Example: ${prefix + command} hi Solo-leveling play command is not working`)
...
await conn.sendMessage(from, {text: xeonlod[i], edit: key })
                  ...
                  await conn.sendMessage(`94774589636@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${mek.sender.split("@")[0]}\n\n*Bug Report*\n${q ? q : 'blank'}` })
...
🏮 BOT WEB :- https://solo-leveling-web-site-meda-by-druk.vercel.app/
🏮 BOT SESSION 1 & 2,
    1:- https://rukshan-whit-solo-leveling-session-2.onrender.com
    2:- https://session-by-solo-leveling.onrender.com                    
*🌻Have A Nice Day..*🌻
> ꜱᴏʟᴏ-ʟᴇᴠᴇʟɪɴɢ ʙʏ ʀᴜᴋᴀ ᴏꜰᴄ`
...
if (config.MODE === 'nonbutton') {
  const sections = [
	...
	rows: [
	    ...
	    {title: "2", rowId: prefix + 'ping' , description: 'QUEEN-DINU-MD SPEED'} ,
...
let menuc = `*◈╾──────${category} DOWNLOAD COMMAND LIST──────╼◈*\n\n> Select you want command type and enjoy Solo-leveling md whatsapp bot 👨‍💻\n\n`;
        let wm = '*ꜱᴏʟᴏ-ʟᴇᴠᴇʟɪɴɢ ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴛʜᴇ ᴛᴇᴀᴍ • ʟᴇɢɪᴏɴ ᴏꜰ ᴅᴏᴏᴍ*'	
                ...
                cards: [
                  {
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/r06l0v.jpg' } }, { upload: conn.waUploadToServer })),
          title: menuc,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/xty5x6.jpg' } }, { upload: conn.waUploadToServer })),
          title: menuc1,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/a7aohh.jpeg' } }, { upload: conn.waUploadToServer })),
          title: menuc2,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/mlxq3o.jpg' } }, { upload: conn.waUploadToServer })),
          title: menuc3,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/7arinh.jpg' } }, { upload: conn.waUploadToServer })),
          title: menuc4,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/stw9p5.webp' } }, { upload: conn.waUploadToServer })),
          title: menuc5,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/5rlmlm.jpg' } }, { upload: conn.waUploadToServer })),
          title: menuc6,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/xkf775.jpg' } }, { upload: conn.waUploadToServer })),
          title: menuc8,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/9gnp53.jpeg' } }, { upload: conn.waUploadToServer })),
          title: menuc7,
          gifPlayback: true,
          subtitle: "QUEEN-DINU-MD",
          hasMediaAttachment: false
...
thumbnailUrl: `https://files.catbox.moe/r06l0v.jpg` ,
renderLargerThumbnail: true,
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VbAWWH9BFLgRMCXVlU38" ,
thumbnailUrl: `https://files.catbox.moe/xty5x6.jpg`,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VbAWWH9BFLgRMCXVlU38" ,
thumbnailUrl: `https://files.catbox.moe/mlxq3o.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VbAWWH9BFLgRMCXVlU38" ,
thumbnailUrl: `https://files.catbox.moe/7arinh.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VbAWWH9BFLgRMCXVlU38" ,
thumbnailUrl: `https://files.catbox.moe/stw9p5.webp` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VbAWWH9BFLgRMCXVlU38" ,
thumbnailUrl: `https://files.catbox.moe/5rlmlm.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029VbAWWH9BFLgRMCXVlU38" ,
thumbnailUrl: `https://files.catbox.moe/xkf775.jpg` ,
renderLargerThumbnail: true,
showAdAttribution: false
}
}}, { quoted: mek})
...
const cap = `[👨‍💻 𝗤𝗨𝗘𝗘𝗡 𝗗𝗜𝗡𝗨 𝗠𝗗 👨‍💻]
   ...
   *QUEEN DINU MD WHATSAPP USER BOT* 💫

                     *OUR MISSION*

🐼This is the result of our teams hard work and our LEGION OF DOOM team owns the bots rights and code rights. Therefore, you have no chance to change and submit our bot under any circumstances And 100 Commands And logo, thumbnail,banner Maker Commands Ai Chatbot feathers On Our Bot
...
🎡 *GITHUB:*  https://github.com/NO-REPO/QUEEN-DINU-MD

🪩 *OUR CHANNEL:* https://whatsapp.com/channel/0029VbAWWH9BFLgRMCXVlU38
